...
namespace E_Shop.Data.Migrations
{
    ...
    [Migration("20211130190204_FixedEntries")]
    partial class FixedEntries
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Shop.Models.Cart.CartViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("E_Shop.Data.Models.Order", b =>
                {
                    b.HasOne("E_Shop.Data.Models.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("E_Shop.Models.Cart.CartViewModel", b =>
                {
                    b.HasOne("E_Shop.Data.Models.Order", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("E_Shop.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
